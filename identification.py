...
def _start_identification(username, identification_controller):
    ...
    while True:
        ...
        try:
            max_data_size = 1000
            payload, client_endpoint = identification_socket.recvfrom(
                max_data_size)
...
def set_username(username):
    ...
    _identification_thread = threading.Thread(
        target=_start_identification, args=(username, _identification_controller,))
